...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    VGPensioner* pensioner = [[VGPensioner alloc] init];
    VGBusinessman* businessman = [[VGBusinessman alloc] init];
    VGDoctor* doctor = [[VGDoctor alloc] init];
    
    pensioner.averagePrice = businessman.averagePrice = doctor.averagePrice = self.goverment.averagePrice;
    pensioner.pension = self.goverment.pension;
    pensioner.productForPension = 10;
